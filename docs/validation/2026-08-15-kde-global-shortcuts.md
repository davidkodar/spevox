...
- Application ID: `io.github.davidkodar.Spevox`
...
The development binary also required a valid reverse-DNS application ID backed by an installed desktop entry before the host portal registry would accept it. Release and developer packaging must install `data/io.github.davidkodar.Spevox.desktop` before portal registration.
