...
import io.github.davidkodar.Spevox
...
ApplicationWindow {
    ...
    // System mode follows Plasma's active palette. The explicit Spevox
    ...
    Dialog {
        ...
        contentItem: ColumnLayout {
            ...
            RowLayout {
                ...
                Image { source: "qrc:/qt/qml/io/github/davidkodar/Spevox/assets/spevox-app.png"; sourceSize.width: 42; sourceSize.height: 42; fillMode: Image.PreserveAspectFit }
                ColumnLayout {
                    Layout.fillWidth: true; spacing: 2
                    Text { text: qsTr("Welcome to Spevox"); color: root.primaryText; font.pixelSize: 22; font.weight: Font.Bold }
            ...
            ColumnLayout {
                    ...
                    ColumnLayout {
                        ...
                        Item {
                            ...
                            Column {
                                ...
                                Text { text: qsTr("Spevox stays available in the Plasma system tray when this window is closed."); color: root.secondaryText; font.pixelSize: 13 }
                            }
                            Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        RowLayout {
                            ...
                            ColumnLayout {
                                ...
                                Text { Layout.fillWidth: true; text: qsTr("Spevox uses the Plasma keyboard portal for direct paste and always keeps successful transcripts on the clipboard."); color: root.secondaryText; font.pixelSize: 12; wrapMode: Text.Wrap }
                            }
                ...
                Rectangle {
                    ...
                    ColumnLayout {
                        ...
                        Text { Layout.fillWidth: true; text: qsTr("Plasma controls final Wayland window placement; Spevox requests the selected screen position and keeps the result recoverable if the compositor adjusts it."); color: root.tertiaryText; font.pixelSize: 10; wrapMode: Text.Wrap }
                    }
                }
                ...
                ColumnLayout {
                    ...
                    Text { text: qsTr("Choose and calibrate the microphone Spevox listens to."); color: root.secondaryText; font.pixelSize: 13 }
                }
                        ...
                        Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                Text {
                                    ...
                                    Layout.fillWidth: true
                                    text: qsTr("This engine recognizes English only. With a fixed non-English language, Spevox uses the selected multilingual Whisper model for both preview and final text.")
                                    color: root.accent
                                    font.pixelSize: 11
                                    wrapMode: Text.Wrap
                                }
                                ...
                                RowLayout {
                                    ...
                                    Text { Layout.fillWidth: true; text: controller.parakeetDownloadProgress > 0 ? qsTr("Downloading and verifying the model…") : qsTr("Compiling the native runtime in the background; please keep Spevox open."); color: root.accent; font.pixelSize: 12; wrapMode: Text.Wrap }
                                }
                                RowLayout {
                                    Layout.fillWidth: true
                                    ...
                                    Item {
                                        ...
                                        Item {
                                            ...
                                            ToolButton {
                                                ...
                                                icon.source: "qrc:/qt/qml/io/github/davidkodar/Spevox/assets/trash.svg"
                                                icon.width: 20
                                                icon.height: 20
                ...
                ColumnLayout {
                    ...
                    Text { text: qsTr("A native KDE interpretation of Spevox's macOS visual language."); color: root.secondaryText; font.pixelSize: 13 }
                }
                    ...
                    ColumnLayout {
                        ...
                        Item {
                            ...
                            Column {
                                ...
                                Text { text: qsTr("Use Plasma's accent or a Spevox color."); color: root.secondaryText; font.pixelSize: 13 }
                            }
                            ComboBox {
                                id: accentSelector
                                anchors.right: parent.right
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    ...
                                    ColumnLayout { Layout.fillWidth: true; spacing: 2
                                        ...
                                        Text { Layout.fillWidth: true; text: qsTr("Install Ollama once, start its local server, then download a model without leaving Spevox."); color: root.secondaryText; font.pixelSize: 12; wrapMode: Text.Wrap }
                                    }
                                    ...
                                    RowLayout {
                                        ...
                                        Text {
                                            ...
                                            text: controller.sortformerInstalled
                                                ...
                                                : qsTr("140 MiB verified Spevox GGUF conversion · shared native runtime")
                    ...
                    ListView {
                        ...
                        delegate: Rectangle {
                            ...
                            ColumnLayout {
                                ...
                                RowLayout {
                                    Layout.fillWidth: true
                                    Text { text: qsTr("Spevox"); color: root.secondaryText; font.pixelSize: 11; font.weight: Font.DemiBold }
                                    Item { Layout.fillWidth: true }
                ...
                ColumnLayout {
                    ...
                    Rectangle { Layout.fillWidth: true; implicitHeight: changeContent.implicitHeight + 32; radius: 16; color: root.panel; border.color: root.hairline
                        ColumnLayout { id: changeContent; anchors.fill: parent; anchors.margins: 16; spacing: 10
                            Text { text: qsTr("%1 · The Spevox identity release").arg(controller.appVersion); color: root.primaryText; font.pixelSize: 15; font.weight: Font.DemiBold }
                            Text { text: qsTr("NEW"); color: root.accent; font.pixelSize: 11; font.weight: Font.DemiBold }
                            Text { Layout.fillWidth: true; text: qsTr("• Independent Spevox name and io.github.davidkodar.Spevox desktop identity\n• Original cyan-to-violet speech-to-text icon and wordmark\n• New spevox executable and consistently renamed packages\n• Existing preview settings, models, history, dictionaries, and secrets remain available\n• Clear FluidVoice inspiration credit without reusing its product identity"); color: root.secondaryText; font.pixelSize: 13; lineHeight: 1.25; wrapMode: Text.Wrap }
                            Text { text: qsTr("ENGINEERING"); color: root.accent; font.pixelSize: 11; font.weight: Font.DemiBold; Layout.topMargin: 4 }
                            Text { Layout.fillWidth: true; text: qsTr("• Legacy XDG data compatibility without copying or deleting user files\n• Updated desktop, AppStream, Flatpak, Arch, tarball, and KWin metadata\n• Updated credits, third-party notices, release documentation, and repository links\n• Workspace-wide tests, Clippy, RustSec, QML, AppStream, install, and package validation"); color: root.secondaryText; font.pixelSize: 13; lineHeight: 1.25; wrapMode: Text.Wrap }
                            RowLayout { Layout.fillWidth: true
                ...
                ColumnLayout {
                    ...
                    Rectangle { Layout.fillWidth: true; implicitHeight: feedbackContent.implicitHeight + 40; radius: 16; color: root.panel; border.color: root.hairline
                        ColumnLayout { id: feedbackContent; anchors.fill: parent; anchors.margins: 20; spacing: 12
                            Text { text: qsTr("HELP IMPROVE SPEVOX"); color: root.tertiaryText; font.pixelSize: 11; font.weight: Font.Medium }
                            Text { Layout.fillWidth: true; text: qsTr("Report a bug or share an idea through GitHub. The browser opens outside Spevox; nothing is submitted automatically."); color: root.secondaryText; font.pixelSize: 13; wrapMode: Text.Wrap }
                            Button { text: qsTr("Open GitHub issues"); onClicked: Qt.openUrlExternally("https://github.com/davidkodar/spevox/issues") }
                        }
                    }
                }
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Image {
                        ...
                        source: "qrc:/qt/qml/io/github/davidkodar/Spevox/assets/spevox-app.png"
                        sourceSize.width: 44
