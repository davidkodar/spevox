...
pub const PROFILE_BUS_NAME: &str = "io.github.davidkodar.Spevox.Profiles";
...
#[zbus::interface(name = "io.github.davidkodar.Spevox.Profiles")]
impl ProfileBridge {
...
mod tests {
    ...
    async fn local_bridge_receives_bounded_application_identity() {
        ...
        let bus_name = format!("io.github.davidkodar.Spevox.Test{}", std::process::id());
        ...
        let proxy = zbus::Proxy::new(
            ...
            bus_name.as_str(),
            "/Profiles",
            "io.github.davidkodar.Spevox.Profiles",
        )
        .await
