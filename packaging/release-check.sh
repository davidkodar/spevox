...
test -f "${smoke_root}/install/usr/share/icons/hicolor/256x256/apps/spevox-app.png"
test -f "${smoke_root}/install/usr/share/icons/hicolor/512x512/apps/spevox-app.png"
...
test -f "${archive_install}/usr/share/icons/hicolor/512x512/apps/spevox-app.png"
